...
vortex set OPENAI_API_KEY=REDACTED_OPENAI_API_KEY
```
...
vortex set WEBHOOK_SECRET=REDACTED_WEBHOOK_SECRET
    ...
    steps:
      ...
      - name: Deploy with Secrets
        run: |
          ...
          docker run -e DATABASE_URL=postgresql://<user>:<password>@<host>:<port>/<db>
```
